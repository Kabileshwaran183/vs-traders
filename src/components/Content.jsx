function Content (){
    return(
        <>
        <div className="px-12 bg-white py-12">
        <h1 className="text-left font-semi-bold  text-xl md:text-5xl mb-4 px-8 py-8">preferred Title</h1>
                <p className="text-left font-semi-bold text-base md:text-2xl mb-4 px-8 text-gray-500">"change this para -- Photography is more than just capturing images; its about preserving emotions,
